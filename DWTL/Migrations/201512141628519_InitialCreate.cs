namespace DWTL.Migrations
{
    ...
    public partial class InitialCreate : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        DownUser_DownUserId = c.Int(),
                    })
                .PrimaryKey(t => t.CompetitionId)
                .ForeignKey("dbo.DownUsers", t => t.DownUser_DownUserId)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Competitions", "DownUser_DownUserId", "dbo.DownUsers");
            DropForeignKey("dbo.Posts", "Competition_CompetitionId", "dbo.Competitions");
            ...
            DropIndex("dbo.Posts", new[] { "Competition_CompetitionId" });
            DropIndex("dbo.Competitions", new[] { "DownUser_DownUserId" });
